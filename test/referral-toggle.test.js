...
delete require.cache[require.resolve('../dev/automation/referralService')];
delete require.cache[require.resolve('../dev/security/validator')];
delete require.cache[require.resolve('../dev/security/migrator')];

const referralService = require('../dev/automation/referralService');
const validator = require('../dev/security/validator');
const migrator = require('../dev/security/migrator');
...
async function runTests() {
  ...
  const freshService = require('../dev/automation/referralService');
  ...
  const svc2 = require('../dev/automation/referralService');
  svc2.init();
  ...
  delete require.cache[require.resolve('../dev/automation/referralService')];
  const svc2b = require('../dev/automation/referralService');
  svc2b.init();
  ...
  // Restart again
  delete require.cache[require.resolve('../dev/automation/referralService')];
  const svc2c = require('../dev/automation/referralService');
  svc2c.init();
  ...
  const svc3 = require('../dev/automation/referralService');
  svc3.init();
  ...
  const svc4 = require('../dev/automation/referralService');
  svc4.init();
  ...
  const svc5 = require('../dev/automation/referralService');
  svc5.init();
  ...
  const svc6 = require('../dev/automation/referralService');
  svc6.init();
  ...
  const svc7 = require('../dev/automation/referralService');
  svc7.init();
  ...
  const svc8 = require('../dev/automation/referralService');
  ...
  const svc9 = require('../dev/automation/referralService');
  svc9.init();
  ...
  const svc9d = require('../dev/automation/referralService');
  svc9d.init();
  ...
  const svc11 = require('../dev/automation/referralService');
  svc11.init();
  ...
  const svc13 = require('../dev/automation/referralService');
