...
async function runTests() {
  ...
  // ══════════════════════════════════════════════
  const store = require('../dev/automation/rateLimitStore');
  ...
  // ══════════════════════════════════════════════
  const ref = require('../dev/automation/referralService');
  ...
  // ══════════════════════════════════════════════
  const ce = require('../dev/automation/contentEngine');
  ...
  // ══════════════════════════════════════════════
  const qm = require('../dev/automation/queueManager');
  ...
  // ══════════════════════════════════════════════
  const { runAudit } = require('../dev/security/auditor');
  ...
  // ══════════════════════════════════════════════
  const { migrateConfig } = require('../dev/security/migrator');
  try {
    migrateConfig();
  ...
  // ══════════════════════════════════════════════
  const preloadSrc = fs.readFileSync(path.join(__dirname, '../dev/preload.js'), 'utf8');
  const apis = [
  ...
  // ══════════════════════════════════════════════
  const rendererSrc = fs.readFileSync(path.join(__dirname, '../dev/ui/renderer.js'), 'utf8');
  const uiChecks = [
  ...
  // ══════════════════════════════════════════════
  const htmlSrc = fs.readFileSync(path.join(__dirname, '../dev/ui/index.html'), 'utf8');
  const htmlElements = [
